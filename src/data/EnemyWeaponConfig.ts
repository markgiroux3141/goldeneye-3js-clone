...
export const ENEMY_WEAPONS: Record<string, EnemyWeaponDef> = {
  pp7: {
    ...
    accuracy: 0.85,
    range: 8.0,
    gunFile: '/models/enemies/weapons/pp7/gun.glb',
    muzzleFile: '/models/enemies/weapons/pp7/muzzle.glb',
    soundFile: '/sounds/enemies/pistol.wav',
  ...
  kf7: {
    ...
    accuracy: 0.75,
    range: 12.0,
    gunFile: '/models/enemies/weapons/kf7/gun.glb',
    muzzleFile: '/models/enemies/weapons/kf7/muzzle.glb',
    soundFile: '/sounds/enemies/rifle.wav',
  ...
  ar33: {
    ...
    accuracy: 0.8,
    range: 10.0,
    gunFile: '/models/enemies/weapons/ar33/gun.glb',
    muzzleFile: '/models/enemies/weapons/ar33/muzzle.glb',
    soundFile: '/sounds/enemies/rifle.wav',
    position: new THREE.Vector3(-90, 0, 145),
    rotation: new THREE.Euler(0, -1.49, -1.69),
    leftPosition: new THREE.Vector3(0, 0, 0),
  ...
  rcp90: {
    ...
    accuracy: 0.7,
    range: 8.0,
    gunFile: '/models/enemies/weapons/rcp90/gun.glb',
    muzzleFile: '/models/enemies/weapons/rcp90/muzzle.glb',
    soundFile: '/sounds/enemies/rifle.wav',
