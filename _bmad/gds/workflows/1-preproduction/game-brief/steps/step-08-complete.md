...
- Output: "Ready to create the Game Design Document. **Start a fresh context** and run:"
  ```
  /bmad_gds_gdd
  ```
...
- Output: "Game brief saved. When you're ready for the GDD, **start a fresh context** and run:"
  ```
  /bmad_gds_gdd
  ```
