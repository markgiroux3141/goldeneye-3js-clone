...
- {{if needs_narrative}}
  Output: "Ready to create the Narrative Design Document. **Start a fresh context** and run:"
  ```
  /bmad_gds_narrative
  ```
  {{else}}
  Output: "Ready to create the Game Architecture. **Start a fresh context** and run:"
  ```
  /bmad_gds_game-architecture
  ```
  {{/if}}
...
- Output: "Ready to start sprint planning. **Start a fresh context** and run:"
  ```
  /bmad_gds_sprint-planning
  ```
...
- Output: "GDD saved. When ready for the next step, **start a fresh context** and run one of:"
  ```
  /bmad_gds_game-architecture
  /bmad_gds_sprint-planning
  ```
