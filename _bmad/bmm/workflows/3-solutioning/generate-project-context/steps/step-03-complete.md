...
{{build_and_deployment_requirements}}
...
date: '{{date}}'
stepsCompleted:
  ['discovery', 'technology_stack', 'framework_rules', 'api_rules', 'state_rules', 'organization_rules', 'testing_rules', 'deployment_rules', 'anti_patterns']
status: 'complete'
...
- Framework-specific rules are specific and actionable
...
1. AI agents will automatically read this file when implementing (dev-story workflow loads it)
