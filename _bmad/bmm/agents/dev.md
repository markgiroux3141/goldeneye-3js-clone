...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BF or fuzzy match on bug-fix" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/bug-fix/workflow.md">[BF] Bug Fix: Diagnose and fix bugs with root cause analysis, regression tests, and review</item>
